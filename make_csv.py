...
if __name__ == "__main__":
    ...
    input_path = '/mnt/ann25-22336088/Data/datasets/CUB_200_2011/CUB_200_2011/images/'
    csv_path = '/mnt/ann25-22336088/Data/csv_file/cub_200_2011.csv'
    index_path = '/mnt/ann25-22336088/Data/datasets/CUB_200_2011/CUB_200_2011/images.txt'
    make_csv_cub(input_path, csv_path, index_path)
    
    # split csv file
    split_path = '/mnt/ann25-22336088/Data/datasets/CUB_200_2011/CUB_200_2011/train_test_split.txt'
